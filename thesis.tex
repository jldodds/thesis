...
On top of that, we aren't 

One way to be confident that a system is correct is to write a
mathematical specification of what the program should do. This
mathematical model is easier to understand because it lacks the
complexity that a real program needs to work efficiently on a
computer. Then you can use a \emph{program logic} to show that the program
actually implements the specification. If you believe that the program
logic is correct, that means that all you need to understand is the
mathematical specification, not the more complex program.
